...
class OperationsControllerTest < ActionController::TestCase
  ...
  test "should show operation" do
    get :show, :id => operations(:one).to_param
    assert_response :success
  end

  test "should get edit" do
    get :edit, :id => operations(:one).to_param
    assert_response :success
  end

  test "should update operation" do
    put :update, :id => operations(:one).to_param, :operation => { }
    assert_redirected_to operation_path(assigns(:operation))
  end

  test "should destroy operation" do
    assert_difference('Operation.count', -1) do
      delete :destroy, :id => operations(:one).to_param
    end
